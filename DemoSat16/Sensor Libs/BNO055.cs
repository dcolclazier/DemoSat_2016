...
namespace DemoSat16.Sensor_Libs {

    //This is the sensor library for the Adafruit BNO055 9-dof Orientation sensor
    public class Bno055
    {
        ...
        public I2CDevice.Configuration Config => _slaveConfig;

        public bool Init(Bno055OpMode mode)
        {
